    ...
    <Section id="pricing">
      ...
      <div className="flex justify-center">
        <div
          ...
          className="specular flex w-full max-w-2xl gap-1 rounded-full p-1.5"
        >
          {tiers.map((option) => {
              ...
              >
                {selected ? (
                  <motion.span
                    ...
                    className="absolute inset-0 rounded-full border border-edge-gold-strong bg-gradient-to-b from-white/[0.14] to-white/[0.02] shadow-[inset_0_1px_0_0_rgb(255_255_255_/_0.18),0_0_25px_-5px_rgb(212_175_55_/_0.3)]"
                  />
                ) : null}
                <span
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-6">
              <div>
                <p className="tabular font-serif text-[2.75rem] font-light leading-none tracking-[-0.03em]">
                  {tier.price}
                </p>
